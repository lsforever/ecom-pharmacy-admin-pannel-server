...
router.delete(
    ...
    async (req, res) => {
        try {
            ...
            await NormalProduct.deleteMany({
...
router.delete(
    ...
    async (req, res) => {
        try {
            ...
            let output = await NormalProduct.findByIdAndDelete(mongoose.Types.ObjectId(id))
...
router.get('/:id',
    ...
    async (req, res) => {
        try {
            let output = await NormalProduct.findById(req.params.id).populate('category')
            res.status(200).json(output)
